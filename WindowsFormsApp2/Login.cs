...
namespace WindowsFormsApp2
{
    public partial class Login : Form
    {
        ...
        SqlConnection sqlbaglanti = new SqlConnection($@"Data Source=.;Initial Catalog=gasstation;User ID=sysdba;Password=Faruk.1234;Encrypt=True;TrustServerCertificate=True");
